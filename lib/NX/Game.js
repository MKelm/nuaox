...
NX.Game.prototype.showGameOverWindow = function() {
  this.gameOverWindow = new NX.DisplayWindow(this, 400, 80)
...
NX.Game.prototype.update = function(scope) {
  ...
  for (var i = 0; i < scope.shipHandler.enemies.length; i++) {
    ...
    if (playerShipInTargetRange == true && scope.shipHandler.isEnemyShipShootActive(i) == true) {
