...
NX.Version.prototype.constructor = NX.Version;

NX.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
NX.Version.prototype.getVersionHash = function(callback) {
...
NX.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
