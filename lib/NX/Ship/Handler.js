...
NX.ShipHandler.prototype.isRushsEnd = function() {
  var rushNum = this.rushNum + 1;
  console.log(typeof this.rushs["rush"+rushNum]);

  return this.enemies.length == 0 && typeof this.rushs["rush"+rushNum] == "undefined";
}
...
NX.ShipHandler.prototype.initializePlayer = function() {
  ...
  this.player.displayId = this.display.drawShip(
    this.player, 0, nx.pixi.screen.height/nx.pixi.screen.ratio/2 - this.player.size/2
  );
}
